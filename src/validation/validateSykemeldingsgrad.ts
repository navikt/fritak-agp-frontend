...
export interface ValidatesykemeldingsgradResult extends ValidationResult {
  key: ValidateSykemeldingsgradKeys.VALIDATE_SYKEMELDINGSGRAD_LOW | ValidateSykemeldingsgradKeys.VALIDATE_SYKEMELDINGSGRAD_HIGH;
}

export const validateSykemeldingsgrad = (sykemeldingsgrad: string | undefined, required: boolean): ValidatesykemeldingsgradResult | undefined => {
