  ...
  <Panel>
    ...
    <Panel>
      <Normaltekst>
        ...
        ansatte det gjelder er også varslet om søknaden.
    ...
    <Panel>
      <div><Lenke href='/'>Still krav om refusjon</Lenke></div>
      <div><Lenke href='https://loginservice.nav.no/slo'>Logg ut</Lenke></div>
      <div><Lenke href='/min-side-arbeidsgiver/'>Min side arbeidsgiver</Lenke></div>
    </Panel>
