...
const GravidSide = (props: GravidSideProps) => {
  ...
  const [tilretteleggeFeilmelding, setTilretteleggeFeilmelding] = useState<string>(!validated ? EMPTY : REQUIRED_INPUT);
  ...
  const validateForm = () : boolean => {
    ...
    if (tiltak === 'annet') {
      if (!tiltakBeskrivelse) {
        ...
        feil.push({ skjemaelementId: 'tilretteleggeFeilmeldingId', feilmelding: 'Spesifiser hvilke tiltak som er forsøkt' });
      } else {
