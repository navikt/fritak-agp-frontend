...
import InnloggetSide from '../innloggetside/InnloggetSide';
...
export const GravidKrav = (props: GravidKravProps) => {
  ...
  return (
    <ArbeidsgiverProvider>
      <InnloggetSide onOrgChange={onOrgChange}>
            ...
            <SideIndentering>
              <Panel>
                <Ingress className='textfelt-padding-bottom'>
                  Har dere søkt om at <Link to={lenker.Gravid}>NAV dekker sykepenger i arbeidsgiverperioden</Link>,
                  sender dere krav om refusjon her. Vi anbefaler at dere sender kravet før søknaden er ferdig behandlet,
                  så unngår dere at det blir foreldet.
                </Ingress>
                ...
                <Ingress tag='span' className='textfelt-padding-bottom'>
                  ...
                  <Hjelpetekst className='krav-padding-hjelpetekst'>
                    <ul>
                      ...
                      <li>
                        Du må velge <strong>både</strong> første og siste dag. Er fraværet bare på én dag, velger du
                        samme dag to ganger.
                      </li>
                    </ul>
                  </Hjelpetekst>
              ...
              <Panel>
                ...
                <Tekstomrade>
                  NAV vil selv innhente dokumentasjon fra legen hvis det ikke allerede går klart fram av en sykmelding
                  at det er svangerskapet som er årsaken til fraværet.
                </Tekstomrade>
