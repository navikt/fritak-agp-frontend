        ...
        <Panel>
          ...
          <Panel>
            <Normaltekst>
              ...
              <Lenke href="https://www.altinn.no">Altinn</Lenke>. Den ansatte
              har også fått melding om at søknaden er sendt. Trenger du å
          ...
          <Panel>
            <AlertStripeInfo>
              Vi anbefaler at bedriften sender selve refusjonskravet før denne
              søknaden er ferdig behandlet. Da unngår dere å oversitte fristen,
              som er tre måneder.
            </AlertStripeInfo>
          </Panel>
          ...
          <Panel>
            <div>
              <InternLenke to={lenker.KroniskKrav}>
            ...
            <div>
              <Lenke href="/min-side-arbeidsgiver/">
                {t(LangKey.MIN_SIDE_ARBEIDSGIVER)}
              </Lenke>
            </div>
          </Panel>
        </Panel>
