...
describe('beregnRefusjon', () => {
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 33', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 3456789,
      dager: 12,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 33 and belop = 6789', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 6789,
      dager: 12,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 77 and belop = 36789', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 36789,
      dager: 12,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 77 and belop = 14000', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 14000,
      dager: 12,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 89 and belop = 14000,5', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 14000.5,
      dager: 17,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 33 and belop = 10000', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 10000,
      dager: 17,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 100 and belop = 600000', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 600000,
      dager: 17,
  ...
  it('should return an other nicely formated number when sykmeldingsgrad = 50 and belop = 600000', () => {
    const mockPeriode: KroniskKravPeriode = {
      uniqueKey: 'unik',
      belop: 600000,
      dager: 17,
