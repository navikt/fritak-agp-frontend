...
describe("ApplicationRoutes", () => {
  ...
  const makeRoute = (
    path: string,
    arbeidsgivere: Array<Organisasjon> = [{ Name: "" } as Organisasjon]
  ) => (
  ...
  it("should show default", () => {
    ...
    expect(container.textContent).toContain(
      "Skjema for gravide og kronisk syke"
    );
  });
  ...
  it("should show kronisk krav", () => {
    ...
    expect(container.textContent).toContain(
      "KRONISK ELLER LANGVARIG SYK ANSATT"
    );
    expect(container.textContent).toContain(
      "Krav om refusjon av sykepenger i arbeidsgiverperioden"
    );
  });
