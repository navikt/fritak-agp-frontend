...
describe('Environment', () => {
  ...
  it('should return the loginservice url for localhost', () => {
    ...
    expect(env.loginServiceUrl).toBe(
      'https://fritakagp.dev.nav.no/local/cookie-please?subject=13118818924&redirect=http://localhost:3000/fritak-agp/?loggedIn=true'
    );
  });
  ...
  it('should return the loginservice url for preprod dev', () => {
    ...
    expect(env.loginServiceUrl).toBe(
      'https://fritakagp.dev.nav.no/local/cookie-please?subject=13118818924&redirect=https://fritak-agp-frontend.dev.nav.no/fritak-agp/?loggedIn=true'
    );
  });
